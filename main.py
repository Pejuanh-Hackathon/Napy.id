...
# Ensure the environment variable 'GROQ_API_KEY' is set in your system or development environment
api_key = os.getenv("GROQ_API_KEY")
if not api_key:
    raise EnvironmentError("GROQ_API_KEY is not set in environment variables")

# Create the Groq client with the API key fetched from environment variables
